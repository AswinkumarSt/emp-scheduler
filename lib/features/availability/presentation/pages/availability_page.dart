...
import 'package:employee_scheduler/features/task/presentation/pages/task_list_page.dart';
...
class _AvailabilityPageState extends State<AvailabilityPage> {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => AddSlotBottomSheet(
        onAddSlot: (startTime, endTime) {
          ...
          availabilityCubit.addAvailability(widget.userId, startTime, endTime);
        },
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          AvailabilityCubit()..loadUserAvailability(widget.userId),
      child: Scaffold(
        appBar: AppBar(
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        CreateTaskPage(currentUserId: widget.userId),
                  ),
                );
              },
              tooltip: 'Create Task',
              ...
              if (availabilities.isEmpty) {
                return Column(
                  children: [
                    ...
                    // Back to TaskList button at the bottom
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: TextButton(
                          ...
                          child: const Text('Back to TaskList'),
                        ),
                      ),
                    ),
                  ],
